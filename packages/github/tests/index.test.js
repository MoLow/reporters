...
::error title=${WORKSPACE}/tests/fixtures/example.js::[Error: test failed] { failureType: 'subtestsFailed', cause: 'test failed', code: 'ERR_TEST_FAILURE', exitCode: 1, signal: null }
